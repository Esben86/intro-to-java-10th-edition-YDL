...
public class Chapter_06_E15_PrintTaxTable {
	...
	public static double computeTax(int status, double income) {
		...
		if (status == 0) {
			...
			else if (income <= 379250)
				tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (82250 - 33950) * 0.25 + (171550 - 82250) * 0.28 + (income - 171550) * 0.33;
			else
				tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (82250 - 33950) * 0.25 + (171550 - 82250) * 0.28 + (379250 - 171550) * 0.33 + (income - 379250) * 0.35;
		}
			...
			if (income <= 16700)
				...
				tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (208850 - 137050) * 0.28 + (379250 - 208850) * 0.33 + (income - 379250) * 0.35;
		}
