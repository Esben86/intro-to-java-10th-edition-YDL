 ...
 *      Exercise2_1 in a directory will be renamed to Exercise2_01. In java, when you pass
...
public class Chapter_12_E29_RenameFiles {
	...
	public static void renameFiles(File file) {
		...
		if (sb.charAt(sb.lastIndexOf("_") + 1) != '0' && !Character.isDigit(sb.charAt(sb.indexOf("_") + 2))) {
